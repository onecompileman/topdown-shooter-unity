...
public class LevelUpController : MonoBehaviour
{
    ...
    {
        gemText.text = PlayerDataState.gems;
        lifeText.text = PlayerDataState.life;
        manaText.text = PlayerDataState.mana;
    ...
    private void GetUpgradeIndex()
    {
        ...
        weaponSlotUpgrdadeIndex = weaponSlots.FindIndex(gems => PlayerDataState.maxWeaponSlots < gems);
        companionSlotUpgradeIndex = companionSlots.FindIndex(gems => PlayerDataState.maxCompanionSlots < gems);
    }
}
